...
# Ensure script is run inside an activated virtual environment
if [[ -z "$VIRTUAL_ENV" ]]; then
    echo "Error: Please activate your virtual environment before
running this script."
    exit 1
fi
...
# Install RAPIDS and dependencies
echo "=== Installing RAPIDS ==="
...
echo "=== Installing Core Python Packages ==="
pip install pandas numpy networkx jupyter jupyterlab ipykernel plotly streamlit

# Install AI/LLM Framework
echo "=== Installing AI/LLM Framework ==="
pip install "langchain>=0.1.0" "langchain-experimental>=0.0.47"
pip install "langgraph>=0.0.15"
pip install python-arango
...
# curl -OL https://download.arangodb.com/arangodb311/DEBIAN/Release.key
# sudo apt-key add - < Release.key
# echo 'deb https://download.arangodb.com/arangodb311/DEBIAN/ /' | sudo
...
# Verify installations
echo "=== Verifying Installations ==="
python -c "import cugraph; import cudf; print('RAPIDS verification
successful!')" || echo "WARNING: RAPIDS verification failed"
python -c "import networkx; import pandas; import numpy; import
langchain; print('Core packages verification successful!')" || echo
"WARNING: Core packages verification failed"

# Create Jupyter kernel
echo "=== Creating Jupyter Kernel ==="
python -m ipykernel install --user --name $(basename $VIRTUAL_ENV)
--display-name "Python ($(basename $VIRTUAL_ENV))"

echo "=== Installation Complete! ==="
echo "Next steps:"
echo "1. Start ArangoDB service: sudo systemctl start arangodb3"
echo "2. Ensure your virtual environment is activated before using
installed packages"
echo "3. Test installation by running Jupyter: jupyter lab"
